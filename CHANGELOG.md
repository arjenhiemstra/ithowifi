# Changelog — IthoWifi v3.0.0 (since v2.8.0)
...
- Fix: config not saved when done in a certain order (#294)
- Fix: settings not updated in Itho Settings dialog (#310)
- Fix: setting not updated on 1st try from browser cache (#310)
- Fix: Itho settings via API causes reboot (#316)
