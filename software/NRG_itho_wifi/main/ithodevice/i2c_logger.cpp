...
int I2CLogger::i2cLogStart(i2c_cmdref_t cmd_ref)
{
    return i2c_log.put({
        .cmd_origin = cmd_ref,
        .cmd_start = millis(),
...
void I2CLogger::i2cLogErrState(int log_entry_idx, i2c_error_state_t err_state)
{
    i2c_log.peek(log_entry_idx).error_state = err_state;
}

void I2CLogger::i2cLogFinal(int log_entry_idx, i2c_error_state_t finalstate)
{
