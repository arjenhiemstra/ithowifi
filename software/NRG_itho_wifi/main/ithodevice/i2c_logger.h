...
public:
    ...
    int i2cLogStart(i2c_cmdref_t cmd_ref);
    void i2cLogErrState(int log_entry_idx, i2c_error_state_t err_state);
    void i2cLogFinal(int log_entry_idx, i2c_error_state_t finalstate);
