...
SemaphoreHandle_t syslog_queueSemaphore = NULL;
...
{
  if (xSemaphoreTakeFromISR(syslog_queueSemaphore, NULL) == pdTRUE)
  {
    log_msg input;
    va_list args;
    ...
    xSemaphoreGiveFromISR(syslog_queueSemaphore, NULL);
  }
}
