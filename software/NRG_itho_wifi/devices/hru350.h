...
struct ithoLabels ithoHRU350StatusLabels[] {
	{ F("Requested fanspeed (%)"),				F("requested-fanspeed_perc") },
	{ F("Balance (%)"),							F("balance_perc") },
	{ F("Supply fan (RPM)"),					F("supply-fan_rpm") },
	{ F("Supply fan actual (RPM)"),				F("supply-fan-actual_rpm") },
	{ F("Exhaust fan (RPM)"),					F("exhaust-fan_rpm") },
	{ F("Exhaust fan actual (RPM)"),			F("exhaust-fan-actual_rpm") },
	{ F("Supply temp (°C)"),					F("supply-temp_c") },
	{ F("Exhaust temp (°C)"),					F("exhaust-temp_c") },
	{ F("Status"),								F("status") },
	{ F("Room temp (°C)"),						F("room-temp_c") },
	{ F("Outdoor temp (°C)"),					F("outdoor-temp_c") },
	{ F("Valve position"),						F("valve-position") },
	{ F("Bypass position"),						F("bypass-position") },
	{ F("Summercounter"),						F("summercounter") },
	{ F("Summerday (K_min)"),					F("summerday_kmin") },
	{ F("Frost timer"),							F("frost-timer") },
	{ F("Boiler timer"),						F("boiler-timer") },
	{ F("Frost block"),							F("frost-block") },
	{ F("Current position"),					F("current-position") },
	{ F("VKKswitch"),							F("vkkswitch") },
	{ F("GHEswitch"),							F("gheswitch") },
	{ F("Airfilter counter"),					F("airfilter-counter") },
	{ F("Global fault code"),					F("global-fault-code") },
	{ F("Actual Mode"),							F("actual-mode") },
	{ F("Pir fan speed level"),					F("pir-fan-speed-level") },
	{ F("Highest received CO2 value (Ppm)"),	F("highest-received-co2-value_ppm") },
	{ F("Highest received RH value (%RH)"),		F("highest-received-rh-value_rh") },
	{ F("Air Quality (%)"),						F("air-quality_perc") },
	{ F("Remaining override timer (Sec)"),		F("remaining-override-timer_sec") },
	{ F("Fallback speed timer (Sec)"),			F("fallback-speed-timer_sec") },
};
